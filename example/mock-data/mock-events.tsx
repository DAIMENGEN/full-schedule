...
export const mockEvents: Array<FullScheduleEvent> = [
    ...
    },
    {
        ...
        color: "#000000",
        range: {
            start: dayjs("2022-08-31"),
            end: dayjs("2024-11-29")
        },
        resourceId: "6769994271325942397"
    },
    {
        id: "9061206907937352414",
        title: "M6242 SW Maintenance",
        color: "#000000",
        range: {
            start: dayjs("2022-03-01"),
            end: dayjs("2023-07-14")
        },
    ...
    },
    {
        ...
        title: "FuSIA Prototype/R1.00",
        color: "#000000",
        range: {
            start: dayjs("2022-02-28"),
            end: dayjs("2024-02-28")
        },
    ...
    },
    {
        ...
        title: "Euclid SW R2.0",
        color: "#000000",
        range: {
            start: dayjs("2024-04-10"),
    ...
    },
    {
        ...
        title: "WFBPhy Editor R4.06",
        color: "#000000",
        range: {
            start: dayjs("2021-03-31"),
            end: dayjs("2022-12-30")
        },
        resourceId: "2265117022552053554"
    },
    {
        id: "6340927533520682495",
        title: "Maintenance (ATWFBView2/DataManager/Monitor/WFBPHY)",
        color: "#000000",
        range: {
            start: dayjs("2023-06-01"),
            end: dayjs("2024-04-30")
        },
    ...
    },
    {
        ...
        title: "Local Requirement Support",
        color: "#000000",
        range: {
            start: dayjs("2022-03-01"),
            end: dayjs("2023-07-14")
